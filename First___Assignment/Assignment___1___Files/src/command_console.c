        ...
        // Else if mouse has been pressed
            ...
            if(getmouse(&event) == OK) {
                ...
                if(check_button_pressed(vx_decr_btn, &event)) {
                    ...
                    check_limits(&velocity_x, SPEED_MINIMUM, SPEED_MAXIMUM);
                ...
                // Vz-- button pressed
                    ...
                    check_limits(&velocity_z, SPEED_MINIMUM, SPEED_MAXIMUM);

                    sprintf(msg, "%f", velocity_z);
                    int wr_z = write(fd_mz, msg, SIZE);
                    if (wr_z==0){
                        perror ("Cannot write in pipe");
                    }
